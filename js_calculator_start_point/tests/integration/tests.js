...
describe('calculator functionality', function() {
  ...
  it('should concatenate number button clicks', function() {
    ...
    element(by.css('#number2')).click();
    element(by.css('#number5')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('725')
  })
  ...
  it('should be able to clear the running total without affeting the calculation', function() {
    running_total = element(by.css('#running_total'))
    element(by.css('#number7')).click();
    element(by.css('#operator_add')).click();
    element(by.css('#number4')).click();
  ...
  it('should diplay an error when dividing by 0', function() {
    running_total = element(by.css('#running_total'))
    element(by.css('#number7')).click();
    element(by.css('#operator_divide')).click();
